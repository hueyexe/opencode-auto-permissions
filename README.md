...
Automatic, model-driven permission review for OpenCode.

> [!NOTE]
> This project is in early development.

OpenCode Auto Permissions is intended to provide a quiet, hands-off permission
mode: routine actions continue automatically, clearly unsafe actions are
